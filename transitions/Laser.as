	...
	public class laser extends Sprite {
		...
		*/
		...
		public function update(e=null) {
			...
			//bDraw.copyPixels(conf.target.bitmapData,box,origin)
			...
			with (conf) {
				...
				origin.x = laserX
				bBuffer.copyPixels(conf.target.bitmapData,lbox,origin,null,null,true)
				origin.x = 0
			...
			if (conf.maskMode) {
				...
				bData.copyPixels(conf.target.bitmapData,box,origin,bBuffer2,origin,true)
