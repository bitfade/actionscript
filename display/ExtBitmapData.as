...
package bitfade.display {
	...
	public class ExtBitmapData extends BitmapData {
		public function ExtBitmapData(width:int, height:int, transparent:Boolean = true, fillColor:uint = 0xFFFFFFFF) {
			super(width,height,transparent,fillColor)
		}
		
		// draw line from x1,y1 to x2,y2, with specified color, alpha
		// decr is alpha decrement for each iteration
		public function line(x1:int,y1:int,x2:int,y2:int,color:uint,alpha:uint,decr:uint) {
